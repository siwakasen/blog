...
description:
  With Linux, you can combine different tools to create powerful setups. One example is provisioning VMs, and you can turn an old or unused laptop or computer into a hypervisor without spending money on cloud services.
...
```bash
sudo apt install -y qemu-kvm libvirt-daemon-system libvirt-clients virtinst dnsmasq bridge-utils
```
